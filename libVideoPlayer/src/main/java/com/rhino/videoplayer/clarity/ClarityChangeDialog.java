...
import com.rhino.videoplayer.R;
 ...
 **/
public class ClarityChangeDialog extends Dialog {

    private LinearLayout mLinearLayout;
    private int mCurrentCheckedIndex;

    public ClarityChangeDialog(Context context) {
    ...
    private void init(Context context) {
        ...
        mLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClarityChangeDialog.this.dismiss();
            }
        });
    ...
    public void setClarityGrade(List<String> items, int defaultChecked) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            params.topMargin = (i == 0) ? 0 : ScreenUtils.dp2px(getContext(), 16f);
