package com.rhino.videoplayer.view;
...
import com.rhino.videoplayer.utils.LogUtils;
import com.rhino.videoplayer.utils.ActivityUtils;
import com.rhino.videoplayer.VideoPlayerManager;
import com.rhino.videoplayer.controller.VideoPlayerController;
import com.rhino.videoplayer.impl.IVideoPlayer;
import com.rhino.videoplayer.utils.PlayCacheUtils;
import com.rhino.videoplayer.utils.ScreenUtils;
...
public class VideoPlayerView extends FrameLayout implements IVideoPlayer,
    ...
    private IMediaPlayer.OnPreparedListener mOnPreparedListener
        ...
        public void onPrepared(IMediaPlayer mp) {
            ...
            if (continueFromLastPosition) {
                long savedPlayPosition = PlayCacheUtils.getSavedPlayPosition(mContext, mUrl);
    ...
    public void enterFullScreen() {
        ...
        // 隐藏ActionBar、状态栏，并横屏
        ActivityUtils.hideActionBar(mContext);
        ActivityUtils.getActivity(mContext)
                .setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);

        ViewGroup contentView = (ViewGroup) ActivityUtils.getActivity(mContext)
    ...
    public boolean exitFullScreen() {
        if (mCurrentMode == MODE_FULL_SCREEN) {
            ActivityUtils.showActionBar(mContext);
            ActivityUtils.getActivity(mContext).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
    ...
    public void enterTinyWindow() {
        ...
        params.rightMargin = ScreenUtils.dp2px(mContext, 8f);
        params.bottomMargin = ScreenUtils.dp2px(mContext, 8f);
    ...
    public void release() {
        ...
        if (isPlaying() || isBufferingPlaying() || isBufferingPaused() || isPaused()) {
            PlayCacheUtils.savePlayPosition(mContext, mUrl, getCurrentPosition());
        } else if (isCompleted()) {
            PlayCacheUtils.savePlayPosition(mContext, mUrl, 0);
        }
        // 退出全屏或小窗口
        if (isFullScreen()) {
            exitFullScreen();
